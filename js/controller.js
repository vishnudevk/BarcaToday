...
app.controller('matchCtrl', function($scope, $http, $anchorScroll, $location) {
    ...
    $scope.getNews = function(){
        var qry = 'select * from rss where url="https://feedity.com/fcbarcelona-com/WlBbU1BW.rss"';//barca all news
        //var qry = 'select * from rss where url="https://feedity.com/fcbarcelona-com/WlZbWlpR.rss"';//barca football news
