...
app.controller('matchCtrl', function($scope, $http) {
    ...
    $scope.team2 = {name:"Olympiacos F.C.",crest:"http://upload.wikimedia.org/wikipedia/de/9/96/Logo_Olympiakos_Piräus.svg"};
    ...
    $scope.fixtures = [];
     ...
     $scope.loadFixtures = function(){
        ...
        var yql = 'http://query.yahooapis.com/v1/public/yql?q=' + encodeURIComponent('select * from json where url="' + url + '"')+"&format=json" ;//+ '&format=xml&callback=cbFunc';
